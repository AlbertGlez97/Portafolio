          ...
          <div class="hero-image animate-fadeInRight">
            <div class="image-placeholder">
              <div class="placeholder-content">
                ...
                <p>Espacio para tu foto profesional</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="projects-grid">
          <div class="project-card animate-fadeInUp">
            ...
            <div class="project-content">
              ...
              <p>Sitio web para promocionar servicios de estudio fotográfico con diseño responsivo y enfoque visual.</p>
              ...
              <a href="https://www.atotonilcoestudio.com/" target="_blank" class="project-link">
                Ver Proyecto
          ...
          <div class="project-card animate-fadeInUp">
            ...
            <div class="project-content">
              <h3>Carnal MX</h3>
              <p>Proyecto artístico de crónica contemporánea sobre la Ciudad de México con panel administrativo y APIs REST.</p>
              <div class="project-tech">
                <TechIcon 
              ...
              <a href="https://www.carnalmx.com/" target="_blank" class="project-link">
                Ver Proyecto
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M14,3V5H17.59L7.76,14.83L9.17,16.24L19,6.41V10H21V3M19,19H5V5H12V3H5C3.89,3 3,3.9 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V12H19V19Z"/>
                </svg>
...
const atotonilcoTechs: (keyof typeof technologiesData)[] = ['html', 'css', 'javascript', 'dotnet']
const carnalMxTechs: (keyof typeof technologiesData)[] = ['html', 'bootstrap', 'csharp', 'sqlserver']
</script>
